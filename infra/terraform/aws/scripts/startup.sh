...
set_env_value .env OPENAI_BASE_URL "$${OPENAI_BASE_URL:-https://api.openai.com/v1}"
set_env_value .env NEXUS_AGENT_MODEL "$${NEXUS_AGENT_MODEL:-gpt-4o-mini}"
set_env_if_nonempty .env OPENAI_API_KEY "$${OPENAI_API_KEY:-}"
